...
GenSwiftDoc() {
  ...
  sed 's/https\:\/\/eosio.github.io\/eosio-swift\//\/reference\/swiftdocs\//' index.md > tmp.md
  ...
  sed 's/Sources\/EosioSwift/\/reference\/swiftdocs\/Sources\/EosioSwift/g' EXAMPLES.md > tmpA.md
  sed 's/(README\.md/(\/eosdocs\/client-side\/swiftdocs\//g' tmpA.md > EXAMPLES.md
  mv tmp.md EXAMPLES.md
  sed 's/Sources\/EosioSwift/\/reference\/swiftdocs\/Sources\/EosioSwift/g' README.md > tmp2.md
  sed 's/EosioSwift\/EosioTransaction/\/reference\/swiftdocs\/Sources\/EosioSwift\/EosioTransaction/g' tmp2.md > tmp3.md
  mv tmp3.md index.md
